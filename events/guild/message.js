...
module.exports = async (client, message) => {
    ...
    if (cmd.length === 0){
      not_allowed = true;
              ...
              .setDescription(`**Prefix:** \`${prefix}\`\n**Servers: \`${client.guilds.cache.size}\`**\n\n**Support Server:** If You Need Help With Groover Join [**Groover Support Server**](${config.links.server})\n**Invite:** Invite Me By Clicking [**Here**](${config.links.opmusicinv})\n**Vote Me:** Enjoying Music With Me? Consider Voting Me On [**Top.GG**](${config.links.opmusicvote})`)
